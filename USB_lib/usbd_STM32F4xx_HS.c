...
//---------------
/*
Ponizsze piny sa ustawione inaczej w BIOSTICKU lub moga byc inaczej niz w pliku poczatkowym.
*/
//---------------
#define BIOSTICK

#ifndef BIOSTICK
  /*PI11 (OTG_HS_ULPI alternate functon, DIR)                                 */ // ORYGINAL
 ...
 RCC_AHB1PeriphClockCmd(RCC_AHB1Periph_GPIOA | RCC_AHB1Periph_GPIOC, ENABLE); //zegary on
 GPIO_PinAFConfig(GPIOC,GPIO_PinSource2,GPIO_AF_OTG_HS); // podpiecie AF dla GPIOC_Pin_2
 GPIO_PinAFConfig(GPIOC,GPIO_PinSource3,GPIO_AF_OTG_HS); // podpiecie AF dla GPIOC_Pin_3
 GPIO_PinAFConfig(GPIOA,GPIO_PinSource5,GPIO_AF_OTG_HS); // podpiecie AF dla GPIOA_Pin_5
...
//	 /*PC2 (OTG_HS_ULPI alternate functon, DIR)                                 */ // BIOSTICK do zrobienia
//  GPIOC->MODER     =  (GPIOI->MODER  & ~(3  <<  4)) | (2  << 4);
//  GPIOC->OSPEEDR  |=  (3  << 4);
//  GPIOC->AFR[0]    =  (GPIOI->AFR[0] & ~(15 <<  12)) | (10 << 12);

//  /* PC3 (OTG_HS_ULPI alternate function, NXT)                                */ // do zrobienia
//  GPIOH->MODER     =  (GPIOH->MODER  & ~(3  <<   8)) | (2  <<  8);
//  GPIOH->OSPEEDR  |=  (3  <<  8);
//  GPIOH->AFR[0]    =  (GPIOH->AFR[0] & ~(15 <<  16)) | (10 << 16);
