...
/**
 * @brief STM32F4XX Standard Peripherals Library version number V1.1.0CR3
   */
...
#define __STM32F4XX_STDPERIPH_VERSION_RC     (0x03) /*!< [7:0]  release candidate */ 
...
#define ETH_MACMIIAR_CR   ((uint32_t)0x0000001C)  /* CR clock range: 6 cases */ 
  ...
  #define ETH_MACMIIAR_CR_Div62   ((uint32_t)0x00000004)  /* HCLK:100-150 MHz; MDC clock= /62 */
